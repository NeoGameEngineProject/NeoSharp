...
public class PhysicsConstraint : global::System.IDisposable {
  ...
  public SWIGTYPE_p_MString parentName {
    set {
      NeoNativeEnginePINVOKE.PhysicsConstraint_parentName_set(swigCPtr, SWIGTYPE_p_MString.getCPtr(value));
      if (NeoNativeEnginePINVOKE.SWIGPendingException.Pending) throw NeoNativeEnginePINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_MString ret = new SWIGTYPE_p_MString(NeoNativeEnginePINVOKE.PhysicsConstraint_parentName_get(swigCPtr), true);
      if (NeoNativeEnginePINVOKE.SWIGPendingException.Pending) throw NeoNativeEnginePINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }

  public MVector3 pivot {
    set {
      NeoNativeEnginePINVOKE.PhysicsConstraint_pivot_set(swigCPtr, MVector3.getCPtr(value));
    } 
    get {
  ...
  public MVector3 lowerLinearLimit {
    set {
      NeoNativeEnginePINVOKE.PhysicsConstraint_lowerLinearLimit_set(swigCPtr, MVector3.getCPtr(value));
    } 
    get {
  ...
  public MVector3 upperLinearLimit {
    set {
      NeoNativeEnginePINVOKE.PhysicsConstraint_upperLinearLimit_set(swigCPtr, MVector3.getCPtr(value));
    } 
    get {
  ...
  public MVector3 lowerAngularLimit {
    set {
      NeoNativeEnginePINVOKE.PhysicsConstraint_lowerAngularLimit_set(swigCPtr, MVector3.getCPtr(value));
    } 
    get {
  ...
  public MVector3 upperAngularLimit {
    set {
      NeoNativeEnginePINVOKE.PhysicsConstraint_upperAngularLimit_set(swigCPtr, MVector3.getCPtr(value));
    } 
    get {
