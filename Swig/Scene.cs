...
public class Scene : global::System.IDisposable {
  ...
  public Vector3 getAmbientLight() {
    Vector3 ret = new Vector3(NeoNativeEnginePINVOKE.Scene_getAmbientLight(swigCPtr), true);
    return ret;
  }

  public void setAmbientLight(Vector3 light) {
    NeoNativeEnginePINVOKE.Scene_setAmbientLight(swigCPtr, Vector3.getCPtr(light));
  ...
  public void setGravity(Vector3 gravity) {
    NeoNativeEnginePINVOKE.Scene_setGravity(swigCPtr, Vector3.getCPtr(gravity));
    if (NeoNativeEnginePINVOKE.SWIGPendingException.Pending) throw NeoNativeEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public Vector3 getGravity() {
    Vector3 ret = new Vector3(NeoNativeEnginePINVOKE.Scene_getGravity(swigCPtr), true);
    return ret;
  }
