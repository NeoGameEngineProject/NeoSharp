...
public class OText : Object3d {
  ...
  public void setColor(MVector4 color) {
    NeoNativeEnginePINVOKE.OText_setColor(swigCPtr, MVector4.getCPtr(color));
    if (NeoNativeEnginePINVOKE.SWIGPendingException.Pending) throw NeoNativeEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public MVector4 getColor() {
    MVector4 ret = new MVector4(NeoNativeEnginePINVOKE.OText_getColor(swigCPtr), true);
    return ret;
  }
