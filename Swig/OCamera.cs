...
public class OCamera : Object3d {
  ...
  public MVector3 getFogColor() {
    MVector3 ret = new MVector3(NeoNativeEnginePINVOKE.OCamera_getFogColor(swigCPtr), true);
    return ret;
  }

  public void setFogColor(MVector3 color) {
    NeoNativeEnginePINVOKE.OCamera_setFogColor(swigCPtr, MVector3.getCPtr(color));
    if (NeoNativeEnginePINVOKE.SWIGPendingException.Pending) throw NeoNativeEnginePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setClearColor(MVector3 clearColor) {
    NeoNativeEnginePINVOKE.OCamera_setClearColor(swigCPtr, MVector3.getCPtr(clearColor));
    if (NeoNativeEnginePINVOKE.SWIGPendingException.Pending) throw NeoNativeEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public MVector3 getClearColor() {
    MVector3 ret = new MVector3(NeoNativeEnginePINVOKE.OCamera_getClearColor(swigCPtr), true);
    return ret;
  }

  public MVector3 getProjectedPoint(MVector3 point) {
    MVector3 ret = new MVector3(NeoNativeEnginePINVOKE.OCamera_getProjectedPoint(swigCPtr, MVector3.getCPtr(point)), true);
    if (NeoNativeEnginePINVOKE.SWIGPendingException.Pending) throw NeoNativeEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public MVector3 getUnProjectedPoint(MVector3 point) {
    MVector3 ret = new MVector3(NeoNativeEnginePINVOKE.OCamera_getUnProjectedPoint(swigCPtr, MVector3.getCPtr(point)), true);
    if (NeoNativeEnginePINVOKE.SWIGPendingException.Pending) throw NeoNativeEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public MMatrix4x4 getCurrentViewMatrix() {
  ...
  public MMatrix4x4 getCurrentProjMatrix() {
