...
public class OLight : Object3d {
  ...
  public void setColor(MVector3 color) {
    NeoNativeEnginePINVOKE.OLight_setColor(swigCPtr, MVector3.getCPtr(color));
    if (NeoNativeEnginePINVOKE.SWIGPendingException.Pending) throw NeoNativeEnginePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public MVector3 getColor() {
    MVector3 ret = new MVector3(NeoNativeEnginePINVOKE.OLight_getColor(swigCPtr), true);
    return ret;
  }

  public MVector3 getFinalColor() {
    MVector3 ret = new MVector3(NeoNativeEnginePINVOKE.OLight_getFinalColor(swigCPtr), true);
    return ret;
  }
