...
public class Level : global::System.IDisposable {
  ...
  public void sendToUpdateQueue(DataRef arg0) {
    NeoNativeEnginePINVOKE.Level_sendToUpdateQueue(swigCPtr, DataRef.getCPtr(arg0));
  }

  public void sendToClearQueue(DataRef arg0) {
    NeoNativeEnginePINVOKE.Level_sendToClearQueue(swigCPtr, DataRef.getCPtr(arg0));
  }
